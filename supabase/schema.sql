...
-- ============================================================
-- 4. ai_poster_requests (AI 포스터 프롬프트 기록)
-- ============================================================
CREATE TABLE ai_poster_requests (
  id                       UUID        PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE INDEX idx_star_gifts_giver_id ON star_gifts (giver_id);
CREATE INDEX idx_star_gifts_receiver_id ON star_gifts (receiver_id);
CREATE INDEX idx_star_gifts_created_at ON star_gifts (created_at DESC);
